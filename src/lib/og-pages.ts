...
export const ogPages: OgPage[] = [
  ...
  { slug: 'review', title: 'Leave a review for Afia Labs Studio', eyebrow: 'Thank you · 30 seconds', subtitle: 'A quick Google review helps other small businesses find the studio when they search for help with their websites.', footerRight: 'afialabs.net/review' },
  ...
  { slug: 'services-security-readiness', title: 'Security Readiness', eyebrow: 'Studio Services', subtitle: 'Look ready. Sound credible. Security readiness for small businesses, SaaS startups, and growing teams. Reviews, policies, vendor questionnaires, and advisory.', footerRight: 'afialabs.net/services/security-readiness' },
